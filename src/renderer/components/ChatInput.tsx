...
export default function ChatInput() {
        ...
        try {
          ...
          if (result.success) {
            ...
            try {
              ...
              log('Mic access granted, tracks: ' + mediaStream.getAudioTracks().length + ', sampleRate: ' + mediaStream.getAudioTracks()[0]?.getSettings()?.sampleRate);
          ...
          log('Failed to start recording: ' + msg);
          setIsRecording(false);
        }
      } else {
              ...
              if (!chatResult.success) {
                ...
                if (fallbackResult.success) {
                  ...
                  addMessage({
                    id: Date.now().toString() + '_err',
                    role: 'assistant',
                    text: '请求失败: ' + (fallbackResult.error || '未知错误'),
                    isError: true,
                    timestamp: new Date(),
                  });
                }
  ...
  }, [isRecording, currentSessionId, addMessage, setIsLoading, setCurrentTranscription, log]);
