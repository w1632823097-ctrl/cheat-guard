...
- Name: basic.spec.ts >> CheatGuard 基础功能 >> 截图 OCR 功能
- Location: e2e\basic.spec.ts:101:7
...
Call log:
  - waiting for locator('.screenshot-btn')
    - locator resolved to <button title="截图识别" id="screenshotBtn" class="screenshot-btn ">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div id="toolbar" class="toolbar">…</div> intercepts pointer events
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <div class="window-wrapper">…</div> intercepts pointer events
  - retrying click action
    - waiting 100ms
...
- generic [ref=e3]:
  ...
  - generic [ref=e16]:
    ...
    - generic [ref=e35]:
      - generic [ref=e36]: 💬
      - paragraph [ref=e37]: 开始你的第一次对话
    - generic [ref=e38]:
      - textbox "输入问题..." [ref=e39]
      - generic [ref=e41]:
        - button "DeepSeek V4 Flash" [ref=e43] [cursor=pointer]:
          - generic [ref=e44]: DeepSeek V4 Flash
          - img [ref=e45]
        - button "截图识别" [ref=e47] [cursor=pointer]:
          - img [ref=e48]
        - button "开始录音" [ref=e52] [cursor=pointer]:
          - img [ref=e53]
        - button [disabled] [ref=e56] [cursor=pointer]:
          - img [ref=e57]
```
